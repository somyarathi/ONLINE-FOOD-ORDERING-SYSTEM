...
<body>
            ...
            <div class="row">
              ...
              <div>
				...
				while($row = mysqli_fetch_array($result))
				{
					...
					echo '<input id="'.$row["id"].'" name="'.$row['id'].'" type="number" data-error=".errorTxt'.$row["id"].' required"><div class="errorTxt'.$row["id"].'"></div></td></tr>';
				}
				?>
                    </tbody>
</table>
  ...
  <!-- //////////////////////////////////////////////////////////////////////////// -->
    ...
    $("#formValidate").validate({
      ...
      if($sum == 0){
        echo '<script>alert("Atleast add one item to the cart"); window.location.href="index.php";</script>';
      }
